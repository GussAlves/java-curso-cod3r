...
public class Filter {
	...
	public static void main(String[] args) {
		...
		Predicate<Aluno> aprovados = a -> a.nota >= 7; // Alterando o predicate 
		Function<Aluno, String> saudacaoAprovado =
				a -> "Parabéns " + a.nome + "! Você foi aprovado(a)!";
		
		alunos.stream()
			.filter(aprovados) // Filter utiliza um predicado portanto retorna true or false
			.map(saudacaoAprovado) // Lambda Expression 
